...
cell_code = {
    ...
    "source": [
        ...
        "    img_path = None\n",
        "    \n",
        "    # First, try using image_path column if it exists and is a string\n",
        "    if 'image_path' in row and pd.notna(row['image_path']) and isinstance(row['image_path'], str):\n",
        "        img_path = inbreast_image_dir / row['image_path']\n",
        "    \n",
        "    # If not found, try common naming patterns using image_id\n",
